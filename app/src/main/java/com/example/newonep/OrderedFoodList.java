        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            holder.button3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent mainIntent = new Intent(OrderedFoodList.this, SelectPaymentMethod.class);
                    OrderedFoodList.this.startActivity(mainIntent);
                    OrderedFoodList.this.finish();
                }
            });
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (name.equals("")) {
                                ...
                                Toast.makeText(OrderedFoodList.this, "Updated successfully", Toast.LENGTH_SHORT).show();
