...
import com.example.ceylonparadise.Models.SelectedDeliveryItems;
...
public class SelectedDeliveryList extends AppCompatActivity {

    ListView listView;
    List<SelectedDeliveryItems> user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selected_delivery_list);

        listView = (ListView) findViewById(R.id.deliverlist);
        user = new ArrayList<>();
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot studentDatasnap : dataSnapshot.getChildren()) {
                    ...
                    SelectedDeliveryItems selectedDeliveryItems = studentDatasnap.getValue(SelectedDeliveryItems.class);
                    user.add(selectedDeliveryItems);

                }

                MyAdapter adapter = new MyAdapter(SelectedDeliveryList.this, R.layout.custom_food_deliver_deails, (ArrayList<SelectedDeliveryItems>) user);
    ...
    class MyAdapter extends ArrayAdapter<SelectedDeliveryItems> {
        LayoutInflater inflater;
        Context myContext;
        List<SelectedDeliveryItems> user;


        public MyAdapter(Context context, int resource, ArrayList<SelectedDeliveryItems> objects) {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                view = inflater.inflate(R.layout.custom_food_deliver_deails, null);

                holder.COL1 = (TextView) view.findViewById(R.id.fooditem_idd);
                holder.COL2 = (TextView) view.findViewById(R.id.fooditem_Namee);
                holder.COL3 = (TextView) view.findViewById(R.id.fooditem_Pricce);
                holder.COL4 = (TextView) view.findViewById(R.id.fooditem_UNamee);
                holder.COL5 = (TextView) view.findViewById(R.id.fooditem_UNicc);
                holder.COL6 = (TextView) view.findViewById(R.id.fooditem_Ucont);
                holder.COL7 = (TextView) view.findViewById(R.id.fooditem_Ucadd);
                holder.COL8 = (TextView) view.findViewById(R.id.fooditem_Uqty);
                holder.imageView1 = (ImageView) view.findViewById(R.id.fooditem_imageee);
                holder.button1 = (Button) view.findViewById(R.id.fooditemedit);
                holder.button2 = (Button) view.findViewById(R.id.fooditemdelete);
                    ...
                    final AlertDialog alertDialog = new AlertDialog.Builder(getContext())
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    FirebaseDatabase.getInstance().getReference("DeliveryItems").child(idd).removeValue();
                    ...
                    buttonupdate.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (name.equals("")) {
                                ...
                                Toast.makeText(SelectedDeliveryList.this, "Updated successfully", Toast.LENGTH_SHORT).show();
